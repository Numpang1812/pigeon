<script lang="ts">
	...
	const props: AvatarUploaderProps = $props();
	...
	const compression_options = {
		...
		maxWidthOrHeight: 1024,    // Max dimension for avatars (good quality for 132px display)
	...
	async function upload_file(file: File) {
		...
		try {
			...
			current_user_image.set(result.imageUrl);
...
<div class="avatar-uploader" class:uploading={is_uploading}>
	<!-- Header -->
	<div class="header">
	...
	{#if props.current_avatar_url && !preview_url}
		<div class="current-avatar">
			<p class="label">Current Avatar</p>
			<img src={props.current_avatar_url} alt="Current avatar" />
		</div>
	{/if}
	...
	{#if preview_url}
		<div class="preview-area">
			<p class="label">New Avatar Preview</p>
